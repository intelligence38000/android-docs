---
title: Custom events
description: Trusted documentation about creating custom milestones with the Mapbox Navigation SDK for Android. Know when to instruct your users or when to hide or show custom UI.
products:
  - Navigation SDK
prependJs:
